    ...
    def get(self, request: Request) -> Response:
        ...
        debug_info = {
            "authentication": {
                ...
                "is_superuser": request.user.is_superuser if hasattr(request, 'user') and request.user.is_authenticated else False,
            },
            "session": {},
            "headers": {},
            "token": None,
        ...
        if hasattr(request, 'session'):
            debug_info["session"] = {
                ...
                "_auth_user_backend": request.session.get('_auth_user_backend') if request.session else None,
            }
